...
class PopularAnimePagination<GlobalModel> extends Cubit<PopularAnimePaginationState<GlobalModel>> {
  ...
  Future<void> fetchNextPage() async {
    ...
    _isLoading = true;
    _safeEmit(PopularAnimePaginationLoading<GlobalModel>(_items));
    ...
    try {
      ...
      _safeEmit(PopularAnimePaginationLoaded<GlobalModel>(List.unmodifiable(_items), hasMore: _hasMore));
    } catch (e, s) {
      _safeEmit(PopularAnimePaginationError<GlobalModel>(_items, e.toString()));

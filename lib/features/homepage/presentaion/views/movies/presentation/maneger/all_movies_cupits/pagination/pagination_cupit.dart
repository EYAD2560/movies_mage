...
class AllPagination<GlobalModel> extends Cubit<AllPaginationState<GlobalModel>> {
  AllPagination({required this.fetchPage}) : super(const PaginationInitial());
  ...
  void _safeEmit(AllPaginationState<GlobalModel> state) {
    if (!isClosed) {
      emit(state);
    } else {
